...
class PhotoAlbumsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create photo_album" do
    assert_difference('PhotoAlbum.count') do
      post photo_albums_url, params: { photo_album: { short_description: @photo_album.short_description, title: @photo_album.title } }
    end
  ...
  test "should update photo_album" do
    patch photo_album_url(@photo_album), params: { photo_album: { short_description: @photo_album.short_description, title: @photo_album.title } }
